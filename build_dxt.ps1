<#
.SYNOPSIS
    Build script for creating the HandBrake MCP DXT package.
.DESCRIPTION
    This script automates the process of creating a DXT package for the HandBrake MCP project.
...
try {
    ...
    Write-Host "3. The HandBrake MCP server should start automatically"
