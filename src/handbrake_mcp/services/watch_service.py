...
class WatchHandler(FileSystemEventHandler):
    ...
    def __init__(self, callback: Callable[[Path], None], patterns: list[str] | None = None):
...
class WatchService:
    ...
    async def start(self, callback: Callable[[Path], None], watch_dirs: list[Path], patterns: list[str] | None = None):
