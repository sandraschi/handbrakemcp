...
4. Start the server:
   ...
   uv run uvicorn handbrake_mcp.server:app --port 10875
   ```
5. Open `http://localhost:10875` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/handbrake-mcp/issues) |
